							...
							<div class="row">
								<div class="col">
									<div class="card shadow mb-3">
										...
										<div class="card-body">
											<form action="UpdateProfile?id_user=<%=etudiant.getUser().getId_user()%>&role=<%=etudiant.getUser().getRole()%>" method="post">
												<div class="row">
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="first_name"><strong>Prenom</strong></label>
															<input class="form-control" type="text" id="first_name" value="<%=etudiant.getUser().getPrenom() %>"
													...
													<div class="col">
														<div class="mb-3">
															...
															<input class="form-control" type="text" id="last_name" value="<%=etudiant.getUser().getNom() %>"
																placeholder="var_value" name="nom" readonly>
														</div>
													</div>
													<div class="col">
														<div class="mb-3">
															<label class="form-label" for="cne"><strong>CNE</strong></label>
															<input class="form-control" type="text" id="cne" value="<%=etudiant.getCne() %>" 
																placeholder="var_value" name="cne" readonly>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col">
														<div class="mb-3">
															...
															<input class="form-control" type="email" id="email" value="<%=etudiant.getUser().getEmail() %>"
													...
													<div class="col">
														<div class="mb-3">
															...
															<input class="form-control" type="password" id="tel" value="<%=etudiant.getUser().getPassword() %>"
													...
													<div class="col">
														<div class="mb-3">
															...
															<input class="form-control" type="text" id="tel" value="<%=etudiant.getUser().getTel() %>"
